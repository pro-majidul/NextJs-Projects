  ...
  return (
    <div className="space-y-5">
      ...
      <section className="dark:bg-gray-100 dark:text-gray-800">
        <div className="container md:flex p-6 mx-auto sm:py-12 lg:py-24 ">
          <div className="flex items-center justify-center p-6 mt-8 lg:mt-0">
            <img src="https://i.ibb.co.com/cSFLJ7KF/contact.jpg" alt="" className="object-contain h-72 sm:h-80 lg:h-96 xl:h-112 2xl:h-128" />
          </div>
